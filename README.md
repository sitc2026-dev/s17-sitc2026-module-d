# SwapLoop Rider SPA — Module D

Build a mobile-first single-page application for SwapLoop riders: find stations, reserve swap or charging services, complete journeys with the competition QR emulator, and show pay-as-you-go receipts from the Module C Main Backend.
...
This project task is written for **Skills IT Training Camp 2026 (SITC 2026)**, Skill 17 — Web Technologies, **Module D**. Authors: **Zoltán Sisák** (HTTP Foundation / Skills IT Hungary). Product briefs: SwapLoop system description and Module D PRD under the SITC 2026 test-project creation materials.

## Content

- [Project Description](project-description.md)
- [Assets](assets/)
- [Marking scheme](marking/marking-scheme.json) (add via marking-scheme creator when ready)
